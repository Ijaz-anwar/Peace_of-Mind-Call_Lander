    ...
    if (isOpen && !initialized && !initRef.current) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            setIsTyping(false);
            addMessage("I'm Emily from Peace Of Mind Insurance", 'agent');
            setTimeout(() => {
              setIsTyping(true);
              setTimeout(() => {
                setIsTyping(false);
              ...
              {msg.type === 'phone' && (
                <div className="aic-bubble">
                  <div className="aic-phone-wrapper">
                    <a href="#tel:+18335494113" className="aic-phone-btn fb_auto_ignore" data-fb-ignore="true" onClick={(e) => handlePhoneCall('+18335494113', e)}>
                      +1 (833) 549-4113
                    </a>
