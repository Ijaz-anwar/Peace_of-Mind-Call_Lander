      ...
      <div className="container">
        <div className="header-content">
          ...
          <nav className="nav">
            ...
            <a href="#tel:+18335494113" className="fb_auto_ignore" data-fb-ignore="true" onClick={(e) => handlePhoneCall('+18335494113', e)}>Contact</a>
          </nav>

          <div className="header-actions">
            <a href="#tel:+18335494113" className="phone-link my-vibrate-button fb_auto_ignore" data-fb-ignore="true" onClick={(e) => handlePhoneCall('+18335494113', e)}>
